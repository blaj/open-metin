...
@GeneratePacketCodec
@PacketHeader(header = 0xf1, direction = PacketDirection.INCOMING, isSequence = true)
@Getter
@Setter
@Accessors(chain = true)
@EqualsAndHashCode
public class ClientVersionPacket implements Packet {

  @PacketField(position = 0, length = 33)
  private String executableName;

  @PacketField(position = 1, length = 33)
