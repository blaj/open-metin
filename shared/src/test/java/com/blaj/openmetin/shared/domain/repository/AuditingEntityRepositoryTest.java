...
@DataJpaTest
@ContextConfiguration(classes = AuditingEntityRepositoryTest.TestConfig.class)
public class AuditingEntityRepositoryTest {

  @Autowired private TestEntityRepository testEntityRepository;

  @Test
  public void givenEntity_whenDelete_thenSoftDeletes() {
    // given
    var entity = testEntityRepository.save(TestEntity.builder().name("name").build());
  ...
  @Test
  public void givenEntityId_whenDeleteById_thenSoftDeletes() {
    // given
    var entity = testEntityRepository.save(TestEntity.builder().name("name").build());
  ...
  @Test
  public void givenMultipleEntities_whenDeleteAll_thenSoftDeletesAll() {
    // given
    var entity1 = testEntityRepository.save(TestEntity.builder().name("name").build());
    var entity2 = testEntityRepository.save(TestEntity.builder().name("name").build());
    ...
    assertThat(result1.get().getDeleted()).isTrue();
    assertThat(result2).isPresent();
    assertThat(result2.get().getDeleted()).isTrue();
  }

  @Test
  public void givenEntities_whenDeleteAll_thenSoftDeletesAllEntities() {
    // given
    var entity1 = testEntityRepository.save(TestEntity.builder().name("name").build());
    var entity2 = testEntityRepository.save(TestEntity.builder().name("name").build());
